<template>
    <div class="popup-bg">
        <div class="popup">
            <div class="popup-header">Create Section</div>
            <div class="body">
                <form ref="myForm" id="section-form">
                    ...
                    <div class="section-description">
                        ...
                        <textarea ref="description" id="description" name="description" placeholder="Description about this section"></textarea>
                    </div><br>
            ...
            <div class="popup-options">
                ...
                <button class="cancel" @click="toggleAddSection">Cancel</button>
            </div>
        </div>
    </div>
</template>
...
export default {
    ...
    methods:{
        ...
        submitForm() {
            axiosClient.post('/api/sections',this.formdata,{
                headers:{
    ...
    props: {
        toggleAddSection: Function, addedToast: Function, reloadPage: Function,
    }
}
</script>
